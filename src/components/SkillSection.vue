...
<template>
  <section class="flex justify-center w-full min-h-full" id="skill">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-8 py-6 w-full">
        <div
          ...
          <div class="flex flex-row-reverse justify-between items-center m-6">
            <div class="flex">
              <Icon
                class="block w-12 lg:w-14 aspect-auto h-auto dark:fill-text fill-text-light"
                :name="skill.icon_path">
              </Icon>
            </div>
            <div>
              <h3
                class="transition-all ease-in-out text-base lg:text-lg 2xl:text-2xl dark:text-text text-text-light font-crimson">
                {{ skill.name }}
              </h3>
              <p
          ...
          <div class="m-6">
            <details class="group">
              <summary class="flex justify-end items-center font-medium cursor-pointer list-none before:content-none">
                <span class="transition group-open:rotate-180">
                  <Icon class="block w-6 aspect-auto h-auto dark:fill-text fill-text-light rotate-90" :name="'arrow'">
                  </Icon>
                </span>
              </summary>
              <div class="w-full mt-8 bg-gray-200 rounded-full dark:bg-gray-700">
                <div
                  class="flex justify-center h-6 rounded-full text-text font-inter"
                  :style="{
                    width: skill.rate + '%',
