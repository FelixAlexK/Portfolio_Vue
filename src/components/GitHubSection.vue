...
<template>
  <section class="flex justify-center w-full min-h-full" id="github">
    <article class="flex flex-col items-start py-8 w-11/12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-8 w-full py-6">
        <a
          class="flex flex-col justify-between w-full dark:bg-card bg-card-light shadow-xl rounded-lg transition-all ease-in-out hover:scale-95 focus:scale-95 focus-visible:outline-1 dark:outline-accent outline-accent-light"
          ...
          <div class="flex flex-row border-t-2 border-gray-500 border-opacity-10 p-4 gap-8">
            <div class="flex flex-row justify-start items-center gap-2 dark:text-text text-text-light text-xs">
              <Icon class="dark:fill-text fill-text-light block aspect-auto w-3 h-auto" :name="'star'"> </Icon>
              {{ project.stargazers_count }}
            </div>
            <div class="flex flex-row justify-start items-center gap-2 text-xs dark:text-text text-text-light">
              <Icon class="dark:fill-text fill-text-light block aspect-auto w-3 h-auto" :name="'fork'"> </Icon>
              {{ project.forks_count }}
            </div>
            <div class="flex flex-row justify-start items-center gap-2 text-xs dark:text-text text-text-light">
              <Icon class="dark:fill-text fill-text-light block aspect-auto w-3 h-auto" :name="'eye'"> </Icon>
